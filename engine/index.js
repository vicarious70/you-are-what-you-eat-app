...
export { generateNudges } from "./nudges.js";
...
export class HealthDNAEngine {
  ...
  // Timely, personalized predictive nudges from the user's logs + learned DNA.
  async nudges(userId, now = new Date()) {
    ...
    const dna = learnHealthDNA(userId, meals, beverages);
    return generateNudges({ profile: profile || {}, meals, beverages, activities, bodyEntries, dna, now });
  }
